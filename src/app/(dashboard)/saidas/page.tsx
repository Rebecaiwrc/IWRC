      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            {language === 'pt' 
              ? 'Controle estratégico de expedição de recicláveis, faturamento de vendas, emissão de romaneios e gestão de saldo em galpão.'
              : 'Strategic control of recyclables dispatches, outbound sales revenue, manifests and warehouse inventory balance.'}
          </p>
        </div>
